...
*
* Obtiene Cxmodelos relacionados del tipo "tiene uno"
*
* @package	tequila.contexto.relaciones
* @author	isaac
* @version	1
*/
class TieneUno extends Relacion{
	/**
	...
	*/
	public function __construct( Cxmodelo $modelo, Contexto $contexto, $foranea = null )
	{
		...
		$this->foranea = isset( $foranea ) ? $foranea : 'id_' . $contexto->table;
	}
	...
	*/
	...
	{
		return $this->contexto->where( $this->foranea, '=', $this->modelo->id )->buscar()->unico();
	}
}