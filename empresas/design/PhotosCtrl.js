...
/**
 * @ngdoc function
 * @name newappApp.controller:PhotosCtrl
 * @description
 * # PhotosCtrl
...
angular.module('newApp')
  .controller('PhotosCtrl', function ($scope, FileReaderFactory, $timeout,  CanvasFactory, ImagesFactory, UtilsFactory, AppSettings) {
	...
	vm.clickUpload = function () {
		if (vm.usedSpace >= AppSettings.maxStorageSpace) {
