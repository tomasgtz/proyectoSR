...
(function(angular, undefined) {
  ...
  /** @const */
  var TEXT_DEFAULTS = {
    toggleOpenLabel: 'Abrir',
    toggleCloseLabel: 'Cerrar',
    searchToggleLabel: 'Buscar',
    search: 'Buscar por nombre',
    toggleSearchLabel: 'Selecciona',
    providerLabel: 'Proveedores',
    subsetLabel: 'Subsets',
    styleLabel: 'Categorias',
    settingsLabel: 'Config',
    noResultsLabel: 'No se encontraron fuentes',
    pageLabel: 'Pag: ',
    fontFabel: 'Fonts: ',
    closeButton: 'Cerrar',
    allFontsListHeadline: 'Todos',
    curatedFontsListHeadline: 'Fonts',
    page: {
      prev: '▲',
      next: '▼'
    },
  ...
  fontselectModule.constant('jdFontselectConfig', {
    googleApiKey: 'AIzaSyCDBS0z21nKGPJuvppFY_MVlUH7eEt4ZRQ'
  });
